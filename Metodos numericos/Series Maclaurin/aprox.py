...
iterations = 10 #numero de iteraciones
x = 0.5 #valor de x
...
for i in range(iterations+1):
    ...
    if true_relative_error_per <= Es and i != 0:
        break
    
    #resultados
    print("{:<12} {:<15.9f} {:<10.9f} {:<16.9f} {:<6.15f}% {:<6.15f}%".format(i, value_per_term, aprox, true_error, relative_error_per, true_relative_error_per))
